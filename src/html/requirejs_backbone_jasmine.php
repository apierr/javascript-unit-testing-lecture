...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Testing a modular web application</title>
...
<![endif]-->
	...
	<body>
		<div class="reveal">
			<div class="slides">
			<?php include("requirejs_backbone_jasmine.html");?>
			</div>
		</div>
<script src="<?=$ROOT_VENDORS?>reveal.js/lib/js/head.min.js"></script>
<script src="<?=$ROOT_VENDORS?>reveal.js/js/reveal.min.js"></script>
<script type="text/javascript" src="<?=$ROOT_VENDORS?>reveal.js/plugin/highlight/highlight.js"></script>
